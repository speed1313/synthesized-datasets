...
def main(dtype: str, tp: int):
    ...
    # root_dir = Path("datasets/wiki_paraphrase/gemma2_9b")
    root_dir = Path("datasets/wiki_paraphrase2/gemma2_9b")
    batch_size = 10000
    ...
    # dataset: ds.Dataset = ds.load_dataset("hpprc/jawiki-paraphrases", "collection", split="train")
